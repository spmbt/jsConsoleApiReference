...
<img src="http://habrastorage.org/getpro/habr/post_images/b83/848/9be/b838489be648753e7f94d468bac7ac2f.png"/></dd></dl></td>
	...
	<th><img src="img/iconSafari.png"/><br> Safari</th>
	<th><img src="img/iconOpera.png"/><br> <span class="abbr" title="ver. 12.15">Opera</span></th>
</tr><tr><td colspan="8"><dl><dt><b>info(object[, object, ...])</b></dt><dd>Аналогична <i>.log()</i>, но оформляется в ином дизайне, для различения типов сообщений, например, для градации важности или для иного смыслового значения этой группы сообщений. Поддерживаются паттерны (описаны в <i>.log()</i>).. Пример различий для Firebug, Chrome, IE9:<br> 
